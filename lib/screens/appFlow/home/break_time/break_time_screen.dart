...
import 'package:hrm_app/screens/appFlow/home/break_time/break_report/break_report_screen.dart';
import 'package:hrm_app/screens/appFlow/home/break_time/break_time_provder.dart';
  ...
  Widget build(BuildContext context) {
    return NoInternetScreen(
      child: ChangeNotifierProvider(
        create: (context) => BreakTimeProvider(controller, context,
            widget.hourHome, widget.minutesHome, widget.secondsHome),
            ...
            return WillPopScope(
              ...
              child: Scaffold(
                appBar: AppBar(
                  ...
                  // backgroundColor: provider.checkStatus == "break_in"
