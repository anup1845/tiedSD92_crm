...
class HomeProvider extends ChangeNotifier {
  ...
  HomeProvider(BuildContext context, LocationProvider locationProvider, CustomTimerController controllerBreakTimer) {
    currentDate();
...
///get crm home screen data
  getCrmHomeData() async {
    ...
    if (kDebugMode) {
      print("Crm provider responde data from provider.................................................... ${response.data}");
    }
