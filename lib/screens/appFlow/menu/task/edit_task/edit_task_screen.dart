...
import 'package:hrm_app/screens/appFlow/menu/task/edit_task/edit_task_provider.dart';
...
class EditTaskScreen extends StatelessWidget {
  const EditTaskScreen({super.key, required this.taskDetails,required this.taskId});
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CreateTaskTextField(
                              ...
                              textController: provider.projectTitleController,
                            ),
                            SizedBox(
                              height: 16.h,
                            ),
                            ...
                            Row(
                              children: [
                                InkWell(
                                  onTap: () {
                                    provider.pickDateRange(context, taskDetails);
                                  },
                                  child: Image.asset(
                            ...
                            ElevatedButton(
                                onPressed: () async {
                                  if (formKey.currentState!.validate()) {
                                    await provider.updateTaskData(context: context,taskId: taskId);
                                  }
                                },
