...
import 'package:hrm_app/screens/custom_widgets/menue_item_dialog.dart';

class TaskAssignListCardWithDate extends StatelessWidget {
  const TaskAssignListCardWithDate(
      {Key? key,
      this.image1,
      this.image2,
      this.image3,
