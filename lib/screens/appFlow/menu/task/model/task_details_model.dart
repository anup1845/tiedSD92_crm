...
import 'package:hrm_app/data/model/home/crm_home_model.dart';
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        clients: List<ClientDetails>.from(json["clients"].map((x) => ClientDetails.fromJson(x))),
        projects: List<ProjectDetails>.from(json["projects"].map((x) => ProjectDetails.fromJson(x))),
        taskDetailsMembers: List<TaskDetailsMembers>.from(json["members"].map((x) => TaskDetailsMembers.fromJson(x))),
        priorities: List<PriorityDetails>.from(json["priorities"].map((x) => PriorityDetails.fromJson(x))),
...
class PriorityDetails {
    ...
    factory PriorityDetails.fromJson(Map<String, dynamic> json) => PriorityDetails(
        title: json["title"],
        id: json["id"],
    );
...
class TaskDetailsMembers {
    ...
    factory TaskDetailsMembers.fromJson(Map<String, dynamic> json) => TaskDetailsMembers(
        id: json["id"],
        name: json["name"],
        avatar: json["avatar"],
        email: json["email"],
