                    ...
                    provider.isLoading == true
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("No field meeting scheduled yet", style: TextStyle(color: AppColors.black, fontSize: 16.sp, fontWeight: FontWeight.bold, ),),
                             Text("Schedule meetings and\neasily record all the events of\nthe meeting.", textAlign: TextAlign.center, style: TextStyle(color: const Color(0xff555555), fontSize: 14.sp, ),)
                          ],
                        ),
                      )
                        : SingleChildScrollView(
